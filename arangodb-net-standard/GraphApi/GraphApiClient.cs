...
namespace ArangoDBNetStandard.GraphApi
{
    ...
    public class GraphApiClient : ApiClientBase, IGraphApiClient
    {
        ...
        {
            var content = GetContent(body, ApiClientSerializationContentType.PostEdge);
            ...
            PostVertexCollectionBody body)
        {
            ...
            var content = GetContent(body, ApiClientSerializationContentType.PostVertex);
            ...
            PutEdgeDefinitionQuery query = null)
        {
            ...
            var content = GetContent(body, ApiClientSerializationContentType.PutEdge);
